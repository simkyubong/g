...
<div id="container">
	...
	<div class="sec2_nowLive_bset">
		...
		<div id="tab-1" class="tab-content current">
			<ul class="">
				...
				<li><a href=""> <img
						src="resources/css/img/navi/naviitem1.jpeg" alt="">
						<div class="pic_text">
							<p class="productBarnd">
								<b>ACNE STUDIOS</b>
							</p>
				...
				<li><a href=""> <img
						src="resources/css/img/navi/naviitem4.jpg" alt="">
						<div class="pic_text">
							<p class="productBarnd">
								<b>A.P.C</b>
							</p>
				...
				<li><a href=""> <img
						src="resources/css/img/navi/naviitem5.jpg" alt="">
						<div class="pic_text">
							<p class="productBarnd">
								<b>JACQUEMUS</b>
							</p>
				...
				<li><a href=""> <img
						src="resources/css/img/navi/naviitem42.jpg" alt="">
						<div class="pic_text">
							<p class="productBarnd">
								<b>LEMAIRE</b>
							</p>
				...
				<li><a href=""> <img
						src="resources/css/img/navi/naviitem43.jpg" alt="">
						<div class="pic_text">
							<p class="productBarnd">
								<b>FENDI</b>
							</p>
				...
				<li><a href=""> <img
						src="resources/css/img/navi/naviitem45.jpg" alt="">
						<div class="pic_text">
							<p class="productBarnd">
								<b>LOEWE</b>
							</p>
				...
				<li><a href=""> <img
						src="resources/css/img/navi/naviitem29.jpeg" alt="">
						<div class="pic_text">
							<p class="productBarnd">
								<b>ISABEL</b>
							</p>
			...
			<ul>
				<li><a href=""> <img
						...
						<div class="pic_text">
							...
							<p class="productPirce">￦ 451,000</p>
						</div>
				</a></li>
				<li><a href=""> <img
						src="resources/css/img/pink/pinkitem20.jpeg" alt="">
						<div class="pic_text">
							...
							<p class="productPirce">￦ 396,000</p>
						</div>
				</a></li>
				<li><a href=""> <img
						src="resources/css/img/pink/pinkitem27.jpg" alt="">
						<div class="pic_text">
							<p class="productBarnd">
								<b>BURBERRY</b>
							</p>
							<p class="productName">리본 레이스 트리밍 골지</p>
							<p class="productPirce">￦ 989,000</p>
						</div>
				</a></li>
				<li><a href=""> <img
						src="resources/css/img/pink/pinkitem28.jpg" alt="">
						<div class="pic_text">
							<p class="productBarnd">
								<b>LORO PIANA</b>
							</p>
							<p class="productName">줄무늬 가디건</p>
							<p class="productPirce">￦ 162,000</p>
						</div>
				</a></li>
				<li><a href=""> <img
						src="resources/css/img/pink/pinkitem24.jpg" alt="">
						<div class="pic_text">
							<p class="productBarnd">
								<b>RAEY</b>
							</p>
							<p class="productName">브이넥 골지 가디건</p>
							<p class="productPirce">￦ 734,000</p>
						</div>
				</a></li>
				<li><a href=""> <img
						src="resources/css/img/pink/pinkitem14.jpeg" alt="">
						<div class="pic_text">
							...
							<p class="productPirce">￦ 472,000</p>
						</div>
				</a></li>
				<li><a href=""> <img
						src="resources/css/img/pink/pinkitem15.jpeg" alt="">
						<div class="pic_text">
							...
							<p class="productPirce">￦ 348,000</p>
						</div>
				</a></li>
				<li><a href=""> <img
						src="resources/css/img/pink/pinkitem30.jpeg" alt="">
						<div class="pic_text">
							<p class="productBarnd">
								<b>MARINE</b>
							</p>
							<p class="productName">케이블 니트 울 블렌드 스웨터</p>
							<p class="productPirce">￦ 578,000</p>
						</div>
				</a></li>
			</ul>
	...
	<div class="sec4_signature_item">
		...
		<div class="signature_in">
			<ul>
				<li><a href=""> <img
						src="resources/css/img/burgundy/burgundy1.jpg" alt="">
						<div class="pic_text">
							<p class="productBarnd">
								<b>THE ROW</b>
							</p>
							<p class="productName">로고 자수 스웨터</p>
							<p class="productPirce">￦ 958,000</p>
						</div>
				</a></li>
				<li><a href=""> <img
						src="resources/css/img/burgundy/burgundy2.jpg" alt="">
						<div class="pic_text">
							<p class="productBarnd">
								<b>GANNI</b>
							</p>
							<p class="productName">빅 로고 스웨터 탑</p>
							<p class="productPirce">￦ 1,779,000</p>
						</div>
				</a></li>
				<li><a href=""> <img
						src="resources/css/img/burgundy/burgundy3.jpg" alt="">
						<div class="pic_text">
							<p class="productBarnd">
								<b>CHROE</b>
							</p>
							<p class="productName">캐시미어 스웨터</p>
							<p class="productPirce">￦ 483,000</p>
						</div>
				</a></li>
				<li><a href=""> <img
						src="resources/css/img/burgundy/burgundy4.jpg" alt="">
						<div class="pic_text">
							<p class="productBarnd">
								<b>KIJUN</b>
							</p>
							<p class="productName">벨티드 코튼 블렌드 원피스</p>
							<p class="productPirce">￦ 885,000</p>
						</div>
				</a></li>
				<li><a href=""> <img
						src="resources/css/img/brown/brownitem8.jpg" alt="">
						<div class="pic_text">
							<p class="productBarnd">
								<b>BSB</b>
							</p>
							<p class="productName">니티드 벨트 캐시미어 가디건</p>
							<p class="productPirce">￦ 1,185,000</p>
						</div>
				</a></li>
				<li><a href=""> <img
						src="resources/css/img/brown/brownitem71.jpeg" alt="">
						<div class="pic_text">
							<p class="productBarnd">
								<b>CALE</b>
							</p>
							<p class="productName">브이넥 골지 탑 상의</p>
							<p class="productPirce">￦ 778,000</p>
						</div>
				</a></li>
				<li><a href=""> <img
						src="resources/css/img/brown/brownitem32.jpeg" alt="">
						<div class="pic_text">
							<p class="productBarnd">
								<b>CAPRI</b>
							</p>
							<p class="productName">로고 컷 상의 코트</p>
							<p class="productPirce">￦ 247,000</p>
						</div>
				</a></li>
				<li><a href=""> <img
						src="resources/css/img/brown/brownitem43.jpeg" alt="">
						<div class="pic_text">
							<p class="productBarnd">
								<b>D'ELLE</b>
							</p>
							<p class="productName">패널 모헤어 상의</p>
							<p class="productPirce">￦ 351,000</p>
						</div>
				</a></li>
			</ul>
	...
	<div class="sec5_best">
		...
		<div class="best_in">
			<ul>
				...
				<li><a href=""> <img
						src="resources/css/img/yellow/yellowitem4.jpg" alt="">
						<div class="pic_text">
							<p class="productBarnd">
								<b>JIL SANDER</b>
							</p>
				...
				<li><a href=""> <img
						src="resources/css/img/khaki/khakiitem5.jpeg" alt="">
						<div class="pic_text">
							<p class="productBarnd">
								<b>Scaai</b>
							</p>
		...
		<div class="sec6_event_in">
			...
			<div class="envnt_list">
				<ul class="envnt_list_1">
					<li><a href=""><img
							src="resources/css/img/event/event01.jpg" alt=""></a></li>
					<li><a href=""><img
							src="resources/css/img/event/event02.jpg" alt=""></a></li>
				</ul>
				<!-- envnt_list_1 -->
				<ul class="envnt_list_2">
					<li><a href=""><img
							src="resources/css/img/event/event4.jpeg" alt=""></a></li>
					<li><a href=""><img
							src="resources/css/img/event/event5.jpeg" alt=""></a></li>
					<li><a href=""><img
							src="resources/css/img/event/event6.jpeg" alt=""></a></li>
					<li><a href=""><img
							src="resources/css/img/event/event7.jpeg" alt=""></a></li>
				</ul>
				<!-- envnt_list_2 -->
			</div>
			<!-- envnt_list -->
